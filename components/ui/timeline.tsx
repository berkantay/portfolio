    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-400 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          I&apos;ve been working on various projects and roles. Here&apos;s a
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-fuchsia-500 via-lime-300  to-transparent from-[10%] via-[40%] rounded-full"
          />
        </div>
      </div>
    </div>
